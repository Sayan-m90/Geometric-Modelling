...
BezierMesh(mes, outMesh,20,20,coord);
return outMesh;
...
int main()
{
    ...
    cout<<"inside";
    Bspline bip;
    Mesh outmesh = bip.BsplineMesh(m,filename2);
    outputOFF_mesh(outmesh, "C:\\Users\\mesay\\OneDrive\\Documents\\C++\\Mesh\\output\\bspline.off");
    cout<<"from bez system";
    return 1;
    Loop lup;
    Mesh inmesh = lup.LoopMeshGen(m);
    outputOFF_mesh(inmesh, "C:\\Users\\mesay\\OneDrive\\Documents\\C++\\Mesh\\output\\loopGen.off");
...
//    Mesh m1 = BezierPatch(m);
    ...
    outputOFF_mesh(m1, "C:\\Users\\mesay\\OneDrive\\Documents\\C++\\Mesh\\output\\loop.off");
